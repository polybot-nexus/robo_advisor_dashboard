...
def update_graphs(rows):
    ...
    fig_trans = px.scatter(data_frame=df, x='#', y='transconductance', color='coating_on_top.substrate_label')
    style_plot(fig_trans)

    # Device Plot
    fig_device = px.scatter(data_frame=df, x='thickness', y='transconductance', color='coating_on_top.substrate_label')
    style_plot(fig_device)

    # Coating Speed Plot
    fig_speed = px.scatter(data_frame=df, x='coating_on_top.vel', y='transconductance', color='coating_on_top.substrate_label')
    style_plot(fig_speed)

    # Coating Temperature Plot
    fig_temp = px.scatter(data_frame=df, x='coating_on_top.T', y='transconductance', color='coating_on_top.substrate_label')
    style_plot(fig_temp)
